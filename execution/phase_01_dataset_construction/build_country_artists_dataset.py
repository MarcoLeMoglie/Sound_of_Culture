#!/usr/bin/env python3
"""Phase-based bridge for the country-artist universe builder."""
...
if __name__ == "__main__":
    run_legacy_script("execution/step4_country_artists/build_country_artists_dataset.py")
else:
    export_legacy_module(
        "execution/step4_country_artists/build_country_artists_dataset.py",
        globals(),
        module_name="soc_phase01_build_country_artists_dataset",
    )
