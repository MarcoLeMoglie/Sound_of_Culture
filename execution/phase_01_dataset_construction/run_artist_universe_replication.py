...
def copy_code(project_root: Path, package_root: Path) -> None:
    mapping = [
        (
            project_root / "execution" / "phase_01_dataset_construction" / "run_artist_universe_replication.py",
            package_root / "code" / "python" / "phase_01_dataset_construction" / "run_artist_universe_replication.py",
        ),
        (
            project_root / "execution" / "phase_01_dataset_construction" / "do" / "run_artist_universe_replication.do",
        ...
        (
            project_root / "execution" / "phase_01_dataset_construction" / "enrich_artist_universe_missing_metadata.py",
            package_root / "code" / "python" / "phase_01_dataset_construction" / "enrich_artist_universe_missing_metadata.py",
        ),
    ]
