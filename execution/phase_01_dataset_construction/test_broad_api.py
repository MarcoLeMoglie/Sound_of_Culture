#!/usr/bin/env python3
"""Phase-based bridge for broad API testing."""
...
if __name__ == "__main__":
    run_legacy_script("execution/step1_download/test_broad_api.py")
else:
    export_legacy_module(
        "execution/step1_download/test_broad_api.py",
        globals(),
        module_name="soc_phase01_test_broad_api",
    )
