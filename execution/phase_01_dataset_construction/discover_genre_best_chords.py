...
def discover_best_chords():
    ...
    output_file = "data/phase_01_dataset_construction/intermediate/json/input_songs_bulk_country.json"
    ...
    processed_queries = []
    if os.path.exists("data/phase_01_dataset_construction/intermediate/json/discovery_progress.json"):
        with open("data/phase_01_dataset_construction/intermediate/json/discovery_progress.json", "r") as f:
    ...
    for query in queries:
        ...
        with open("data/phase_01_dataset_construction/intermediate/json/discovery_progress.json", "w") as f:
