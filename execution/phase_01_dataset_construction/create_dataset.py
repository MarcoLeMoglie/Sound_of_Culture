#!/usr/bin/env python3
"""Phase-based bridge for top100 dataset creation."""
...
if __name__ == "__main__":
    run_legacy_script("execution/step2_digitalize/create_dataset.py")
else:
    export_legacy_module(
        "execution/step2_digitalize/create_dataset.py",
        globals(),
        module_name="soc_phase01_create_dataset",
    )
