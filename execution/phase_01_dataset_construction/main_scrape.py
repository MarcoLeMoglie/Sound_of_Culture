#!/usr/bin/env python3
"""Phase-based bridge for main scrape execution."""
...
if __name__ == "__main__":
    run_legacy_script("execution/step1_download/main_scrape.py")
else:
    export_legacy_module(
        "execution/step1_download/main_scrape.py",
        globals(),
        module_name="soc_phase01_main_scrape",
    )
