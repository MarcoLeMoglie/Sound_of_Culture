...
def main():
    import sys
    input_file = sys.argv[1] if len(sys.argv) > 1 else "data/phase_01_dataset_construction/intermediate/json/input_songs.json"
    ...
    if not items:
        print("No items to process. Please create data/phase_01_dataset_construction/intermediate/json/input_songs.json with a list of songs/artists.")
        return
