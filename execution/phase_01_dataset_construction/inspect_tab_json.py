#!/usr/bin/env python3
"""Phase-based bridge for tab-JSON inspection."""
...
if __name__ == "__main__":
    run_legacy_script("execution/step1_download/inspect_tab_json.py")
else:
    export_legacy_module(
        "execution/step1_download/inspect_tab_json.py",
        globals(),
        module_name="soc_phase01_inspect_tab_json",
    )
