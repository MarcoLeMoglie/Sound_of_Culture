...
* 5.5. Assicura che gli indici sintetici siano numerici (per Bass)
destring complexity energy melodicness repetition playability finger_movement disruption structure_variation loop_strength root_stability intra_root_variation harmonic_palette harmonic_softness, replace force
...
* Cartella di Output
capture mkdir "execution/phase_02_exploratory_analysis/output_figures_bass"
local out "execution/phase_02_exploratory_analysis/output_figures_bass"
