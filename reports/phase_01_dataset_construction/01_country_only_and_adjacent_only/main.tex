...
Metric & Count \\
\midrule
Rows still missing \texttt{birth\_state} & 132 \\
Rows still coded as missing or \texttt{Unknown} in \texttt{us\_macro\_region} & 121 \\
Rows explicitly coded as \texttt{Non-US} in \texttt{us\_macro\_region} & 2,768 \\
Rows still missing \texttt{birth\_country} & 121 \\
Unique artists still missing \texttt{birth\_state} & 43 \\
Unique artists still missing or \texttt{Unknown} in \texttt{us\_macro\_region} & 39 \\
Unique artists explicitly coded as \texttt{Non-US} in \texttt{us\_macro\_region} & 144 \\
Unique artists still missing \texttt{birth\_country} & 39 \\
