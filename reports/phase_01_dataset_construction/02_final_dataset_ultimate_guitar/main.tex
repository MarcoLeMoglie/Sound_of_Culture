...
\midrule
Rows missing \texttt{bpm} & 37,939 & 21,515 \\
Rows missing \texttt{genre} & 2,398 & 109 \\
Rows with official genre source (\texttt{genre\_is\_official = 1}) & 0 & 20,752 \\
Rows missing \texttt{birth\_state} in the final song file & 273 & 132 \\
Rows missing or \texttt{Unknown} in \texttt{us\_macro\_region} & 2,474 & 121 \\
...
Genre source & Rows \\
\midrule
\texttt{apple\_music\_track} & 17,587 \\
\texttt{deezer\_album\_genre} & 3,053 \\
\texttt{discogs\_release} & 112 \\
\texttt{artist\_metadata\_fallback} & 767 \\
\texttt{ug\_selected} & 22,430 \\
Still empty & 109 \\
\midrule
BPM source & Rows \\
\midrule
\texttt{apple\_preview\_estimated} & 14,799 \\
\texttt{deezer\_track} & 1,396 \\
\texttt{deezer\_preview\_estimated} & 229 \\
