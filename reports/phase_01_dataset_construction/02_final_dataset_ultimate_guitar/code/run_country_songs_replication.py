...
def copy_assets(project_root: Path, package_root: Path) -> None:
    mapping = [
        (
            project_root / "execution" / "phase_01_dataset_construction" / "run_country_songs_replication.py",
            package_root / "code" / "python" / "phase_01_dataset_construction" / "run_country_songs_replication.py",
        ),
        (
            project_root / "execution" / "phase_01_dataset_construction" / "do" / "run_country_songs_replication.do",
