...
INPUT_CSV = os.path.join(script_dir, "../output/Sound_of_Culture_Country_Full.csv")
OUTPUT_CSV = os.path.join(script_dir, "../output/Sound_of_Culture_Country_Full_Enriched.csv")
CACHE_FILE = os.path.join(script_dir, "../data/release_years_cache.json")
