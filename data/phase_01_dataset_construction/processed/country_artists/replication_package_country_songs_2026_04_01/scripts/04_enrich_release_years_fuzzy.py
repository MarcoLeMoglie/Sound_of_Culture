...
# Paths relative to replication root
script_dir = os.path.dirname(os.path.abspath(__file__))
INPUT_CSV = os.path.join(script_dir, "../output/Sound_of_Culture_Country_Full_Enriched.csv")
OUTPUT_CSV = os.path.join(script_dir, "../output/Sound_of_Culture_Country_Full_v1.csv")
CACHE_FILE = os.path.join(script_dir, "../data/release_years_cache_fuzzy.json")
